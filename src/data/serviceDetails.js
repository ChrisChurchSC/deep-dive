...
export const serviceDetails = {
  'brand-people': {
    ...
    relatedProjects: projects.filter(p => p.category === 'Brand & People'),
  },
  ...
  'customer-community': {
    ...
    whatItIs: {
      ...
      secondary: "SurvivorNet ran this format across a series of patient stories — real people, real doctors, real stakes. The result was a 55% view-through rate. The industry benchmark is 2%. That gap is what authentic storytelling does.",
    },
    whenToUse: [
    ...
    relatedProjects: projects.filter(p => p.category === 'Customer & Community'),
  },
  ...
  'industry-platform': {
    ...
    whatItIs: {
      ...
      secondary: "The brand benefit is authority. When your logo is on the most insightful thing in your category, you own that category intellectually. Vitalik Buterin's blockchain deep-dive did this for a Web3 client — the film was widely cited as the clearest explanation of what that technology was actually for.",
    },
    whenToUse: [
    ...
    relatedProjects: projects.filter(p => p.category === 'Industry & Platform'),
  },
}
