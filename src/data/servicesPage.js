...
const fallback = {
  ...
  categories: [
    ...
    { slug: 'customer-community', name: 'Customer & Community', tagline: 'Real people, real results. Social proof that feels earned, not staged.', description: 'Long-form customer success stories, transformation narratives, and community films that build genuine trust. Not "testimonials" — full stories with stakes, struggle, and resolution.', examples: ['Customer success stories', '"Day in the Life" films', 'Before/after narratives', 'Community impact docs'], video: '/previews/customer-community.mp4', thumbnail: null },
