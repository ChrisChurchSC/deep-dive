...
const articleBodies = {
  ...
  'why-your-brand-film-needs-a-narrative-arc': `
...
**How we structure for one or the other**
    ...
    When a project starts with us, the first conversation is about what the content is actually for. If the answer is awareness, we build short, emotionally compressed pieces with clear payoffs and we measure shares and reach. If the answer is conversion, we build longer pieces with full narrative arcs and real subjects and we measure finish rate and pipeline lift.
